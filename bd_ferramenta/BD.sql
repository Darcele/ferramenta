...
CREATE TABLE `tb_arquivo` (
  ...
  `caminho` varchar(800) NOT NULL,
  `id_par` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_par` (`id_par`),
  CONSTRAINT `tb_arquivo_ibfk_1` FOREIGN KEY (`id_par`) REFERENCES `tb_parametro` (`id`)
...
CREATE TABLE `tb_parametro` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_doc` (`id_doc`),
  CONSTRAINT `tb_parametro_ibfk_1` FOREIGN KEY (`id_doc`) REFERENCES `tb_documento` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-20 12:59:47
